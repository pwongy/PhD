...
/** Model exported on Mar 2 2015, 14:05 by COMSOL 4.3.0.233. */
public class temp {
  ...
  public static Model run() {
    ...
    model
         .modelPath("B:\\Temp\\Modelling\\3. GP_complete\\4. COMSOL\\2.1. Validation update\\BC");

    model.name("GP_v2.0_mainBV_sph_43_BC-root.mph");
    ...
    model.material("mat8").selection().set(new int[]{6, 14});
    model.material().create("mat9");
    model.material("mat9").selection().set(new int[]{3, 11});
    model.material().create("mat10");
    model.material("mat10").selection().set(new int[]{16, 20, 22});
    model.material().create("mat11");
    model.material("mat11").selection().set(new int[]{13});
    model.material().create("mat12");
    model.material("mat12").selection().set(new int[]{12});
    model.material().create("mat13");
    model.material("mat13").selection().set(new int[]{5});
    model.material().create("mat14");
    model.material("mat14").selection().set(new int[]{1});
    model.material().create("mat15");
    model.material("mat15").selection().set(new int[]{7});
    model.material().create("mat16");
    model.material("mat16").selection().set(new int[]{10});

    model.physics().create("ec", "ConductiveMedia", "geom1");
    model.physics("ec").feature().create("ein2", "ElectricInsulation", 2);
    model.physics("ec").feature("ein2").selection().set(new int[]{42});
    model.physics("ec").feature().create("ein3", "ElectricInsulation", 2);
    model.physics("ec").feature("ein3").selection()
         .set(new int[]{15617, 15618, 15619, 15620});
    ...
    model.physics("ec").feature("gnd3").selection().set(new int[]{27004});
    model.physics("ec").feature().create("gnd4", "Ground", 2);
    model.physics("ec").feature("gnd4").selection().set(new int[]{15619});
    model.physics("ec").feature().create("gnd5", "Ground", 2);
    model.physics("ec").feature("gnd5").selection()
         .set(new int[]{15613, 15614, 15615, 15616});

    model.coordSystem().create("ie1", "geom1", "InfiniteElement");
    model.coordSystem("ie1").selection().set(new int[]{28});
    ...
    model.material("mat4").propertyGroup("def")
         .set("electricconductivity", new String[]{"1/13.73", "0", "0", "0", "1/13.73", "0", "0", "0", "1/13.73"});
    model.material("mat4").propertyGroup("def")
         .set("relpermittivity", new String[]{"1", "0", "0", "0", "1", "0", "0", "0", "1"});
    ...
    model.material("mat6").propertyGroup("def")
         .set("electricconductivity", new String[]{"1/11.7", "0", "0", "0", "1/11.7", "0", "0", "0", "1/11.7"});
    model.material("mat6").propertyGroup("def")
         .set("relpermittivity", new String[]{"1", "0", "0", "0", "1", "0", "0", "0", "1"});
    ...
    model.physics("ec").feature("ein3").name("Small sphere insulation");
    ...
    model.physics("ec").feature("gnd4").selection().active(false);
    model.physics("ec").feature("gnd4").active(false);
    model.physics("ec").feature("gnd4").name("Caudal bone ground");
    model.physics("ec").feature("gnd5").selection().active(false);
    model.physics("ec").feature("gnd5").active(false);
    model.physics("ec").feature("gnd5").name("All ground (infinite)");
    ...
    model.coordSystem("ie1")
         .set("r0", new String[]{"2.500e-3", "4.000e-3", "2.250e-3"});
    ...
    model.sol("sol1").feature("s1").feature("dDef").set("pardmtsolve", true);
    model.sol("sol1").feature("s1").feature("aDef")
         .set("convinfo", "detailed");
    model.sol("sol1").feature("s1").feature("i1").set("linsolver", "cg");
    model.sol("sol1").feature("s1").feature("i1").feature("mg1")
         .set("prefun", "amg");

    model.batch("b1").feature("cl1")
         .set("filename", "B:\\Temp\\Modelling\\3. GP_complete\\4. COMSOL\\2. Validation\\Java\\bin\\SetupFromRootBC.class");
    ...
    model.name("GP_v2.0_mainBV_sph_43_BC-root.mph");
    model.name("BC-term4-inf_gnd.mph");
    ...
    model.result().dataset("cpt2").name("Cut Point 3D 2 - RC refined");
    model.result().dataset("cpt2").set("method", "file");
    model.result().dataset("cpt2")
         .set("filename", "B:\\Temp\\Modelling\\3. GP_complete\\5. MATLAB\\cutpoints_RC_AN.csv");
    model.result().dataset("cpt2").run();
    model.result().export().create("data2", "cpt2", "Data");
    model.result().export("data2").name("VRC for AF");
    model.result().export("data2").set("expr", new String[]{"dom"});
    model.result().export("data2").set("descr", new String[]{"Domain index"});
    model.result().export("data2").set("expr", new String[]{"dom", "V"});
    model.result().export("data2")
         .set("descr", new String[]{"Domain index", "Electric potential"});
    model.result().export("data2")
         .set("filename", "B:\\Temp\\Modelling\\3. GP_complete\\4. COMSOL\\2.1. Validation update\\BC\\Tables\\V.csv");
